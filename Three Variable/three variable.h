...
typedef struct Lines_three_I1{
	double f1;
	double f2;
	double f3;
	struct Lines_three_I1* next;
}Lines_three_I1;

//linked list of pairs of lines
typedef struct three_pairs{
  Lines_three_I1* first;
  Lines_three_I1* second;
  double cl_alpha;
  double cl_beta;
  int type;
  struct three_pairs* next;
}three_pairs;

typedef struct q_pairs{
	three_pairs* i3;
	three_pairs* i4;
	double u;
	double v;
...
//linked list with three element data
typedef struct Lines_three_I0{
	double h1;
	double h2;
	double h3;
	struct Lines_three_I0* next;
}Lines_three_I0;
...
void three_variable(double *, double *,double *,double *,double*, double*, int);
int line_search(Lines_three_I1*, Lines_three_I0*, double, double, double, double);
